...
/**
 * GET /api/superadmin/audit-groups/my-scope
 *
 * Called by the audit-dashboard for an authenticated team_lead.
 * Returns the merged set of signal_client_ids and signal_org_ids that
 * the team lead may access via admin-assigned groups.
 *
 * This replaces / supplements the old team_lead_org_access check.
 * If the team lead has no groups assigned, they see nothing.
 */
